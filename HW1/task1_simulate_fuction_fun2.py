...
Y_Rand = np.sign(np.sin(5 * np.pi * X_Rand)).astype(np.float32)
...
plt.plot(x_values.numpy(), predictions_model1, label='Model 1 Predictions')
plt.plot(x_values.numpy(), predictions_model2, label='Model 2 Predictions')
plt.plot(x_values.numpy(), predictions_model3, label='Model 3 Predictions')
plt.xlabel('Input')
plt.ylabel('Output')
